<template>
  <div>
    <b-row>
      ...
      <b-col cols="12" lg="6">
        <app-analysis-notes-and-history :analysis="analysis" />
      </b-col>
      <b-col cols="12" lg="6">
...
import AppAnalysisNotesAndHistory from "@/app/analysis/edit-analysis/edit-analysis-admin/analysis-notes-and-history.vue";
